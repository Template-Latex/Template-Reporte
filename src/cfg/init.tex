...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={3.3.2-REPT},
		Template.Version.Hash={7A04EA2AE7B433297C391F3E57C60F92},
	...
	pdfproducer={Template-Reporte v3.3.2 | (Pablo Pizarro R.) ppizarror.com},
