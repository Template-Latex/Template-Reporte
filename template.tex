...
\def\GLOBALenvimagenewlinemarg {0.135}   % Entorno images activo [cm]
...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={2.0.0-beta-8-REPT},
		Template.Version.Hash={19D66636B905ECEE0795AD24339BF48C},
	...
	pdfproducer={Template-Reporte v2.0.0 | (Pablo Pizarro R.) ppizarror.com},
